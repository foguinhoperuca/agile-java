...
public class PieceTest extends TestCase {
	...
	public void testCreate() {
		...
		verifyCreation(Piece.createWhiteBishop(), Piece.createBlackBishop(), Piece.Type.BISHOP, Piece.Type.BISHOP.getRepresentation());
		verifyCreation(Piece.createWhiteQueen(), Piece.createBlackQueen(), Piece.Type.QUEEN, Piece.Type.QUEEN.getRepresentation());
		verifyCreation(Piece.createWhiteKing(), Piece.createBlackKing(), Piece.Type.KING, Piece.Type.KING.getRepresentation());
		verifyCreation(Piece.createWhitePawn(), Piece.createBlackPawn(), Piece.Type.PAWN, Piece.Type.PAWN.getRepresentation());
