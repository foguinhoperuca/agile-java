...
/**
 * Define a board to play chess. Contains all pieces in a simple data structure
 * and understand the grid layout of the board. Format:<br/>
 * pppppppp<br/>
 * rnbqkbnr<br/>
 * ........<br/>
 * ........<br/>
...
public class Board {
    ...
    // FIXME make sense to have these lists below?
    ...
    /*
     * FIXME Estou com dificuldade em criar 2 contrutores para atender as
	...
	int numberOfPawns = 0;
	// FIXME implement representation of piece, by color, using a map type
    ...
    // TODO implement test for movePiece()
    /**
	...
	int startX = getPositionX();
	int startY = getPositionY();
	if (!_piece.canMakeAMove(_piece.getType(), startX, startY, x, y))
	    return false;
    ...
    // TODO implement pieceIsBlocked()
    // TODO implement test for pieceIsBlocked()
    /**
     * Define if a piece is blocked or not.
     * 
     * @param _piece
    ...
    // TODO implement test for capture()
    /**
     * Capture one piece.
     * 
     * @param _piece
    ...
    // TODO implement getPositionX()
    // TODO implement test for getPositionX()
    /**
     * Return the specific position X.
     * 
     * @return position X.
     */
    ...
    // TODO implement getPositionY()
    // TODO implement test for getPositionY()
    /**
     * Return the specific position Y.
     * 
     * @return position Y.
     */
